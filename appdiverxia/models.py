...
class Cliente(models.Model):
    ...
    corcli = models.CharField(max_length=45)
    estcli = models.TextField()  # This field type is a guess.
...
class Destino(models.Model):
    ...
    estdes = models.TextField()  # This field type is a guess.
...
class Empleado(models.Model):
    ...
    fechemp = models.CharField(max_length=45)
    #telemp = models.CharField(max_length=45)
    celemp = models.CharField(max_length=9)
    corremp = models.CharField(max_length=45)
    estemp = models.TextField()  # This field type is a guess.
    codusu = models.ForeignKey('Usuario', models.DO_NOTHING, db_column='codusu')
...
class Entrada(models.Model):
    ...
    estent = models.TextField()  # This field type is a guess.
...
class Producto(models.Model):
    ...
    estpro = models.TextField()  # This field type is a guess.
...
class Proveedor(models.Model):
    ...
    corrprov = models.CharField(max_length=45)
    rucprov = models.CharField(max_length=45)
    estprov = models.TextField()
...
class Salida(models.Model):
    ...
    estsal = models.TextField()  # This field type is a guess.
...
class Ticket(models.Model):
    ...
    est = models.TextField()  # This field type is a guess.
