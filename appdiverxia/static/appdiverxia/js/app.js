	...
	*************************************************/
	...
	function setThemeState() {
		...
		if (themeSettings.themeName) {
			$styleLink.attr('href', '/static/appdiverxia/css/app-' + themeSettings.themeName + '.css');
		}
		else {
			$styleLink.attr('href', '/static/appdiverxia/css/app.css');
		}
...
function validarTodo(tipo)
{
	...
	if(tipo == 'proveedor')
	{
		...
		if( (isNaN(parseFloat(documento.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-La documento es obligatoria y solo puede llevar numeros. </p>"
		}
	...
	if(tipo == 'cliente')
	{
		...
		if( (isNaN(parseFloat(documento.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-La documento es obligatoria solo puede llevar numeros. </p>"
		}
	...
	if(tipo == 'opciones')
	{
		...
		let valor_igv = document.getElementById('valor_igv')
		let mensaje_factura = document.getElementById('mensaje_factura')
		let nombre_negocio = document.getElementById('nombre_negocio')	

		if( (isNaN(parseFloat(valor_igv.value)) ) )
		{
			error = true
			mensaje += "<p class='" + claseErrores +"'>" +
			 "-En el campo de IGV solo pueden ir digitos. </p>"
		}
