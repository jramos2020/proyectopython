    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            if logeado is not None:
                ...
                return HttpResponseRedirect('/appdiverxia/panel')
            else:
...
class Salir(LoginRequiredMixin, View):
    ...
    def get(self, request):
        logout(request)
        return HttpResponseRedirect('/appdiverxia/login')
#Fin de vista----------------------------------------------------------------------#
        ...
        if modo == 'editar':
            ...
            if p == 1:
                if request.user.nivel != 2:
                    ...
                    return HttpResponseRedirect('/appdiverxia/perfil/ver/%s' % p)
    ...
    def post(self,request,modo,p):
        if modo ==  'editar':
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect("/appdiverxia/perfil/ver/%s" % perf.id)
            else:
                #De lo contrario lanzara el mismo formulario
            ...
            if form.is_valid():
                ...
                if(error == 0):
                    ...
                    return HttpResponseRedirect("/appdiverxia/perfil/clave/%s" % p)
...
class Eliminar(LoginRequiredMixin, View):
    ...
    def get(self, request, modo, p):
        ...
        if modo == 'producto':
            ...
            return HttpResponseRedirect("/appdiverxia/listarProductos")
           
        elif modo == 'cliente':
            cliente = Cliente.objects.get(id=p)
            cliente.delete()
            messages.success(request, 'Cliente de ID %s borrado exitosamente.' % p)
            return HttpResponseRedirect("/appdiverxia/listarClientes")
            ...
            return HttpResponseRedirect("/appdiverxia/listarProveedores")

        elif modo == 'usuario':
            if request.user.is_superuser == False:
                messages.error(request, 'No tienes permisos suficientes para borrar usuarios')  
                return HttpResponseRedirect('/appdiverxia/listarUsuarios')
...
class AgregarProducto(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            prod = Producto(descripcion=descripcion,precio=precio,categoria=categoria,tiene_igv=tiene_igv,disponible=disponible)
            prod.save()
            ...
            return HttpResponseRedirect("/appdiverxia/agregarProducto")
        else:
            #De lo contrario lanzara el mismo formulario
...
class ImportarProductos(LoginRequiredMixin, View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/importarProductos")
...
class EditarProducto(LoginRequiredMixin, View):
    ...
    def post(self,request,p):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/editarProducto/%s" % prod.id)
        else:
            #De lo contrario lanzara el mismo formulario
            return render(request, 'appdiverxia/producto/agregarProducto.html', {'form': form})
...
class AgregarCliente(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/agregarCliente")
        else:
            #De lo contrario lanzara el mismo formulario
...
class ImportarClientes(LoginRequiredMixin, View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/importarClientes")
...
class EditarCliente(LoginRequiredMixin, View):
    ...
    def post(self,request,p):
        ...
        if form.is_valid():           
            ...
            return HttpResponseRedirect("/appdiverxia/editarCliente/%s" % cliente.id)
        else:
            #De lo contrario lanzara el mismo formulario
            return render(request, 'appdiverxia/cliente/agregarCliente.html', {'form': form})
...
class DetallesFactura(LoginRequiredMixin, View):
    ...
    'form-MAX_NUM_FORMS': '',
        ...
        if formset.is_valid():
            ...
            factura = Factura(cliente=cliente,fecha=date.today(),sub_monto=sub_monto,monto_general=monto_general,igv=igv)
            ...
            return HttpResponseRedirect("/appdiverxia/emitirFactura")
...
class AgregarProveedor(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/agregarProveedor")
        else:
            #De lo contrario lanzara el mismo formulario
...
class EditarProveedor(LoginRequiredMixin, View):
    ...
    def post(self,request,p):
        ...
        if form.is_valid():           
            ...
            return HttpResponseRedirect("/appdiverxia/editarProveedor/%s" % proveedor.id)
        else:
            #De lo contrario lanzara el mismo formulario
            return render(request, 'appdiverxia/proveedor/agregarProveedor.html', {'form': form})
...
class DetallesPedido(LoginRequiredMixin, View):
    ...
    'form-MAX_NUM_FORMS': '',
        ...
        if formset.is_valid():
            ...
            igv = igvActual('objeto')
            presente = False
            pedido = Pedido(proveedor=proveedor,fecha=date.today(),sub_monto=sub_monto,monto_general=monto_general,igv=igv,
                presente=presente)
            ...
            return HttpResponseRedirect("/appdiverxia/agregarPedido")
...
class ValidarPedido(LoginRequiredMixin, View):
    ...
    def get(self, request, p):
        ...
        return HttpResponseRedirect("/appdiverxia/verPedido/%s" % p)
#Fin de vista--------------------------------------------------------------------------------------#   
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if(error == 0):
                ...
                return HttpResponseRedirect('/appdiverxia/crearUsuario')
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return HttpResponseRedirect('/appdiverxia/importarBDD')
            except Exception:
...
class ConfiguracionGeneral(LoginRequiredMixin, View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect("/appdiverxia/configuracionGeneral")
        else:
